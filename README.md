...
****************************************
  ...
  Free script for controlling 150-450 g Combat Robots with Android smartphone/tablet via bluetoothLE.  
  ...
  *****
  ...
  - Board:                    esp32 by Espressif Systems v.3.0.5  Install from Arduino IDE      (Uses ESP32 core 3.x)
  ...
  *****
  ...
  Further copyright in scripts read me section. Third party script writers hasn't got nothing to do with this project except I'm using their libraries.
